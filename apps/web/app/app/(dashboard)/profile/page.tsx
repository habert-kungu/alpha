      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
        ...
        <div className="space-y-3 sm:space-y-4">
          <Card className="p-4 sm:p-6 text-center">
            ...
            <div className="mt-3 sm:mt-4 inline-flex items-center px-2 sm:px-3 py-1 bg-[oklch(0.62_0.12_178)/8] text-[oklch(0.62_0.12_178)] rounded-full text-xs sm:text-sm font-medium">
              <span className="w-1.5 h-1.5 bg-[oklch(0.62_0.12_178)] rounded-full mr-1.5 sm:mr-2"></span>
              Verified
            </div>
          </Card>
          ...
          <Card className="p-4 sm:p-6">
            ...
            <div className="space-y-3 sm:space-y-4">
              ...
              <div className="flex justify-between">
                ...
                <span className="text-xs sm:text-sm font-medium text-[oklch(0.62_0.12_178)]">$10,400</span>
              </div>
              <div className="flex justify-between">
