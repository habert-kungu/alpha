        ...
        <div className="space-y-3">
          ...
          <div className="rounded-lg bg-secondary/50 p-3 sm:p-4">
            <div className="flex items-center gap-2 text-xs font-medium text-foreground sm:text-sm">
              ...
              <span className="rounded-full bg-[var(--bg-success)] px-2 py-0.5 text-[10px] font-semibold text-[var(--color-success)]">Required</span>
            </div>
            <div className="mt-0.5 text-[10px] text-muted-foreground sm:text-xs">
              Every sign-in needs your password and a 6-digit code emailed to {tfa?.email || "your address"}. This protects your funds and can&apos;t be turned off.
            </div>
          </div>
