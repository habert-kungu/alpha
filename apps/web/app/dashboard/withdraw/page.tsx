            ...
            <div className="mb-4 sm:mb-5">
              <div className="mb-1.5 flex items-center justify-between sm:mb-2">
                ...
                <button
                  ...
                  className="text-[10px] font-medium text-[oklch(0.55_0_150)] hover:opacity-80 sm:text-xs"
                >
            ...
            <ul className="space-y-2 text-[10px] text-muted-foreground sm:space-y-3 sm:text-xs">
              {[
                ...
                <li key={i} className="flex items-start gap-2">
                  <svg
                    className="mt-0.5 h-3.5 w-3.5 shrink-0 text-[oklch(0.55_0_150)] sm:h-4 sm:w-4"
                    viewBox="0 0 24 24"
                    fill="none"
                    stroke="currentColor"
                    strokeWidth="2"
